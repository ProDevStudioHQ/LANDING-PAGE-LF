...
export const metadata: Metadata = {
  ...
  description:
    "Agence web au Maroc spécialisée en création de sites web professionnels. Sites vitrines, landing pages, CRM sur mesure pour entreprises marocaines. Devis gratuit sous 24h.",
  alternates: {
